...
void add()
{
    ...
    void pres()
    {
        try
        {
        PreparedStatement r=con.prepareStatement("update prescription set findings='"+findings.getText()+"',symptoms='"+symptoms.getText()+"',remarks='"+remarks.getText()+"',disease='"+disease.getText()+"'where pid='"+presid+"'");
