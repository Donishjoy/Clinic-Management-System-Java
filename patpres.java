 ...
 * @author donis
 */
public class patpres extends javax.swing.JFrame {

    /**
     * Creates new form patpres
     */
    public patpres() {
        initComponents();
...
Connection con=conn.mycon();
    ...
    private void initComponents() {
        ...
        patpres = new javax.swing.JTable();
        ...
        jPanel6.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 40, 1020, 320));

        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 1100, 380));

        jPanel7.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        patpres.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(51, 0, 51)));
        patpres.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        patpres.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "SLNO", "DATE", "DISEASE", "INITIAL FINDINGS", "REMARKS"
            }
        ));
        patpres.setAlignmentX(1.0F);
        patpres.setAlignmentY(1.0F);
        patpres.setRowHeight(60);
        patpres.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                patpresMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(patpres);

        jPanel7.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 1050, 320));

        jPanel5.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 1120, 360));
    ...
    private void pattableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pattableMouseClicked
      ...
      System.out.println(id);
        try{
           PreparedStatement d=con.prepareStatement("select ROW_NUMBER() OVER (ORDER BY patid) AS slno,disease,findings,remarks,date(date)'date' from prescription where patid='"+id+"'");
           ResultSet r=d.executeQuery();
           jPanel6.setVisible(false);
           jPanel7.setVisible(true);
           while(r.next())
           {
               String tab[]={r.getString("slno"),r.getString("date"),r.getString("disease"),r.getString("findings"),r.getString("remarks")};
               DefaultTableModel tb=(DefaultTableModel)patpres.getModel();
               tb.addRow(tab);
            }
        }catch(SQLException e){
    ...
    private void patpresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_patpresMouseClicked

    }//GEN-LAST:event_patpresMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(patpres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable patpres;
